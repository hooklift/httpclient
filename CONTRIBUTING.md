...
* In Github, fork `https://github.com/hooklift/httpclient` to your own account
* Get the package using "go get": `go get github.com/hooklift/httpclient`
* Move to where the package was cloned: `cd $GOPATH/src/github.com/hooklift/httpclient`
* Add a git remote pointing to your own fork: `git remote add downstream git@github.com:<your_account>/httpclient.git`
